...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    proceduresSubtitle: Schema.Attribute.String;
    proceduresTitle: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    teamSubtitle: Schema.Attribute.String;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    businessHoursTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Hor\u00E1rio de Funcionamento'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    paymentMethodsLabel: Schema.Attribute.String;
